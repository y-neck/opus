    ...
    <div class="flex flex-col w-full">
        ...
        <main class="p-16">
            <div>
                <div v-if="Object.keys(groupedLinks).length">
                    <div class="my-4 mb-9" v-for="(linksGroup, date) in groupedLinks" :key="date">
                        <h3 class="font-normal text-sm text-grey-500 tracking-[0.01em]">{{ date }}</h3>
                        <hr class="text-grey-100 mt-2">
                            <ul>
                                <li v-for="(link, index) in linksGroup" :key="index">
                                    <div class="flex flex-row my-2">
                                        <div class="mr-2 mt-1">
                                            <img class="w-4 h-4 rounded" :src="getFaviconUrl(link.link)" alt="favicon"></div>
            ...
            <script setup>
                ...
                // Page meta
                definePageMeta({title: 'Documents', description: '', layout: 'default', middleware: 'auth'});
            </script>