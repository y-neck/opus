  ...
  <form class="flex items-center justify-center h-screen mt-[-4rem]" @submit.prevent="handleLogin">
    <div class="flex flex-col">
      <div class="flex flex-col justify-center mb-2">
        ...
        <input
          class="w-[22.125rem] h-10 border text-grey-700 border-grey-100 rounded-lg pl-3 placeholder-grey-400 pr-2 focus:outline-none focus:border-grey-200"
          type="email" placeholder="name@domain.com" v-model="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
          required />
      </div>
